# iwantmail-backend-core

This is a sample template for iwantmail-backend-core - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name iwantmail-backend-core \
...
```bash
sam logs -n HelloWorldFunction --stack-name iwantmail-backend-core --tail
```
...
```bash
aws cloudformation delete-stack --stack-name iwantmail-backend-core
```
